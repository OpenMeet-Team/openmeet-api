...
describe('EventSeries Core Functionality', () => {
  describe('EventSeriesService', () => {
    ...
    test('should create series and first occurrence', () => {
      ...
      const createEvent = jest.fn().mockResolvedValue({ id: 1, slug: 'event-1' });
    ...
    test('should check permissions on update', () => {
      ...
      const updateSeries = jest.fn().mockResolvedValue({ id: 1, name: 'Updated' });
  ...
  describe('EventSeriesOccurrenceService', () => {
    ...
    test('should find occurrence by date', () => {
      ...
      return findOccurrence('test-series', '2025-01-01T10:00:00Z').then(result => {
        expect(result).toBeDefined();
        expect(result.id).toBe(1);
        
        // Test non-existent occurrence
        return findOccurrence('test-series', '2025-01-08T10:00:00Z').then(result => {
    ...
    test('should materialize a new occurrence', () => {
      ...
      const saveEvent = jest.fn().mockImplementation(data => Promise.resolve({
        ...data,
        id: 2,
        slug: 'test-event-2'
      }));
      ...
      return materializeOccurrence('test-series', '2025-01-08T10:00:00Z', 1).then(result => {
        expect(result).toBeDefined();
    ...
    test('should reject invalid occurrence dates', () => {
      ...
      // Test invalid date 
      return materializeOccurrence('test-series', '2025-02-30T10:00:00Z').catch(err => {
        expect(err).toBeDefined();
