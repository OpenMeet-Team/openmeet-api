...
export class GroupPermissions1727982637370 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "${schema}"."groupMember" ADD "userId" integer`,
    );
    await queryRunner.query(
      `ALTER TABLE "${schema}"."groupMember" ADD "groupRoleId" integer`,
    );
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "${schema}"."groupMember" DROP COLUMN "groupRoleId"`,
    );
    await queryRunner.query(
      `ALTER TABLE "${schema}"."groupMember" DROP COLUMN "userId"`,
    );
    await queryRunner.query(
