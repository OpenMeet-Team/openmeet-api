...
export class AddUniqueConstraintToEventAttendees1746030518364
  implements MigrationInterface
{
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    console.log(
      `Applying AddUniqueConstraintToEventAttendees migration in schema ${schema}`,
    );
    ...
    console.log(
      `Successfully added unique constraint to eventAttendees in schema ${schema}`,
    );
  }
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    console.log(
      `Removed unique constraint from eventAttendees in schema ${schema}`,
    );
  }
}
