...
export class UserPermissions1727961422727 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "${schema}"."Group" ALTER COLUMN "slug" DROP DEFAULT`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "${schema}"."Group" ALTER COLUMN "slug" SET DEFAULT 'default-slug'`);
