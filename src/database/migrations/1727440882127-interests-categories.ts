...
export class InterestsCategories1727440882127 implements MigrationInterface {
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        const schema = queryRunner.connection.options.name || 'public';
        await queryRunner.query(`ALTER TABLE "${schema}"."user_interests_interest" DROP CONSTRAINT "FK_d52a2a3498ea0af1471fd200251"`);
        await queryRunner.query(`ALTER TABLE "${schema}"."user_interests_interest" DROP CONSTRAINT "FK_5afca45962c04f51b2e91e03516"`);
        await queryRunner.query(`ALTER TABLE "${schema}"."event_categories_category" DROP CONSTRAINT "FK_0c38526fad528c70c7c5baaa081"`);
        await queryRunner.query(`ALTER TABLE "${schema}"."event_categories_category" DROP CONSTRAINT "FK_9fc5e5dab789917cc33940c08a9"`);
        await queryRunner.query(`ALTER TABLE "${schema}"."category_events_event" DROP CONSTRAINT "FK_99ad0d8882edac5001e8fffaed0"`);
        await queryRunner.query(`ALTER TABLE "${schema}"."category_events_event" DROP CONSTRAINT "FK_5ec511506f673c4d2f9e6a65815"`);
        await queryRunner.query(`ALTER TABLE "${schema}"."interest_users_user" DROP CONSTRAINT "FK_b592f3b3a73b834aec2c32ef644"`);
        await queryRunner.query(`ALTER TABLE "${schema}"."interest_users_user" DROP CONSTRAINT "FK_e6343d90ec0c3f8a80e48624e40"`);
        await queryRunner.query(`ALTER TABLE "${schema}"."Interest" DROP CONSTRAINT "FK_1950059e77da5102d55110b9362"`);
        await queryRunner.query(`DROP INDEX "${schema}"."IDX_d52a2a3498ea0af1471fd20025"`);
        await queryRunner.query(`DROP INDEX "${schema}"."IDX_5afca45962c04f51b2e91e0351"`);
        await queryRunner.query(`DROP TABLE "${schema}"."user_interests_interest"`);
        await queryRunner.query(`DROP INDEX "${schema}"."IDX_0c38526fad528c70c7c5baaa08"`);
        await queryRunner.query(`DROP INDEX "${schema}"."IDX_9fc5e5dab789917cc33940c08a"`);
        await queryRunner.query(`DROP TABLE "${schema}"."event_categories_category"`);
        await queryRunner.query(`DROP INDEX "${schema}"."IDX_99ad0d8882edac5001e8fffaed"`);
        await queryRunner.query(`DROP INDEX "${schema}"."IDX_5ec511506f673c4d2f9e6a6581"`);
        await queryRunner.query(`DROP TABLE "${schema}"."category_events_event"`);
        await queryRunner.query(`DROP INDEX "${schema}"."IDX_b592f3b3a73b834aec2c32ef64"`);
        await queryRunner.query(`DROP INDEX "${schema}"."IDX_e6343d90ec0c3f8a80e48624e4"`);
