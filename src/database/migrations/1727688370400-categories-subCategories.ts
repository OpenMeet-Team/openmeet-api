...
export class CategoriesSubCategories1727688370400 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE INDEX "IDX_55ec55270cbd701570ee9ad979" ON "${schema}"."group_categories_category" ("groupId")`);
        await queryRunner.query(`CREATE INDEX "IDX_c03a1e84ff1bd7302451647fd6" ON "${schema}"."group_categories_category" ("categoryId")`);
        ...
        await queryRunner.query(`CREATE INDEX "IDX_300e9942ce51ca84d7aea6ab29" ON "${schema}"."category_groups_group" ("categoryId")`);
        await queryRunner.query(`CREATE INDEX "IDX_5e5a897361fcbb74c800fe105c" ON "${schema}"."category_groups_group" ("groupId")`);
        ...
        await queryRunner.query(`ALTER TABLE "${schema}"."group_categories_category" ADD CONSTRAINT "FK_55ec55270cbd701570ee9ad9799" FOREIGN KEY ("groupId") REFERENCES "${schema}"."Group"("id") ON DELETE CASCADE ON UPDATE CASCADE`);
        await queryRunner.query(`ALTER TABLE "${schema}"."group_categories_category" ADD CONSTRAINT "FK_c03a1e84ff1bd7302451647fd60" FOREIGN KEY ("categoryId") REFERENCES "${schema}"."Category"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "${schema}"."category_groups_group" ADD CONSTRAINT "FK_300e9942ce51ca84d7aea6ab29e" FOREIGN KEY ("categoryId") REFERENCES "${schema}"."Category"("id") ON DELETE CASCADE ON UPDATE CASCADE`);
        await queryRunner.query(`ALTER TABLE "${schema}"."category_groups_group" ADD CONSTRAINT "FK_5e5a897361fcbb74c800fe105c8" FOREIGN KEY ("groupId") REFERENCES "${schema}"."Group"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
    }
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "${schema}"."category_groups_group" DROP CONSTRAINT "FK_5e5a897361fcbb74c800fe105c8"`);
        await queryRunner.query(`ALTER TABLE "${schema}"."category_groups_group" DROP CONSTRAINT "FK_300e9942ce51ca84d7aea6ab29e"`);
        await queryRunner.query(`ALTER TABLE "${schema}"."group_categories_category" DROP CONSTRAINT "FK_c03a1e84ff1bd7302451647fd60"`);
        await queryRunner.query(`ALTER TABLE "${schema}"."group_categories_category" DROP CONSTRAINT "FK_55ec55270cbd701570ee9ad9799"`);
        ...
        // Drop indexes
        await queryRunner.query(`DROP INDEX "${schema}"."IDX_5e5a897361fcbb74c800fe105c"`);
        await queryRunner.query(`DROP INDEX "${schema}"."IDX_300e9942ce51ca84d7aea6ab29"`);
        await queryRunner.query(`DROP TABLE "${schema}"."category_groups_group"`);
        await queryRunner.query(`DROP INDEX "${schema}"."IDX_c03a1e84ff1bd7302451647fd6"`);
        await queryRunner.query(`DROP INDEX "${schema}"."IDX_55ec55270cbd701570ee9ad979"`);
        await queryRunner.query(`DROP TABLE "${schema}"."group_categories_category"`);
