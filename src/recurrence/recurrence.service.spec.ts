...
describe('RecurrenceService', () => {
  ...
  describe('generateOccurrences', () => {
    it('should generate daily occurrences', () => {
      ...
      expect(occurrences[1].getUTCDate()).toBe(addDays(startDate, 1).getUTCDate());
      expect(occurrences[2].getUTCDate()).toBe(addDays(startDate, 2).getUTCDate());
      expect(occurrences[3].getUTCDate()).toBe(addDays(startDate, 3).getUTCDate());
      expect(occurrences[4].getUTCDate()).toBe(addDays(startDate, 4).getUTCDate());
    });
  ...
  describe('isDateInRecurrencePattern', () => {
    it('should return true for dates in the pattern', () => {
      ...
      const result = service.isDateInRecurrencePattern(checkDate, startDate, rule);
